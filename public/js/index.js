...
layui.config({
    ...
    $.get("/admin/user/system",null,function(data){
        ...
        for(var i=0;i<data.length;i++){
        	var selectedClass = "";
        	if(i == 0) {
        		selectedClass = " layui-this";
        	}
            $('#userItem').before('<li class="layui-nav-item' + selectedClass + '"><a href="javascript:;" onclick="javascript:refreshMenu('+data[i].id+')">'+data[i].title+'</a></li>');
